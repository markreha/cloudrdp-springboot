...
This repository contains the documentation and code to support the [Cloud Portal Application](https://github.com/markreha//cloudrdp-springboot/blob/main/portal-app-spring-boot/HELP.md) and [GCU Custom Java Docker API](https://github.com/markreha/cloudrdp-springboot/blob/master/java-api/README.md).
