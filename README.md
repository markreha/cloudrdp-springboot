...
This repository contains the documentation and code to support the [Cloud Portal Application](https://github.com/markreha//cloudrdp-springboot/blob/main/portal-app-spring-boot/HELP.md) and [Fabric8io Java Kubernetes API](https://github.com/markreha/cloudrdp-springboot/blob/master/java-api/README.md).
